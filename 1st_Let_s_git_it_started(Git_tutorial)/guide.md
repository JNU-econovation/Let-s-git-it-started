...
만약 1) <u>처음 저장소를 clone</u>해오게 되면, 모든 파일은 <b>Tracked</b> 이면서 <b>Unmodified</b> 상태가 됩니다. 이 상태에서 2) <u>어떤 파일을 수정하면</u> 해당 파일은 <b>Tracked</b> 이면서 <b>Modified</b> 상태가 됩니다. <br> 실제로 3) <u>원격 저장소에 변경 내용을 반영하기 위해서</u> 수정한 파일을 <b>Staged</b> 상태로 만들고, <b>Staged</b> 상태의 파일을 <b>Commit</b> 해야 합니다.
...
> remote repo에서 데이터를 가져올 뿐만 아니라(git fetch) 변경된 내용을 local repo의 내용과 병합합니다.(git merge)
